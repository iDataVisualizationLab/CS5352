    ...
    $('#listHolder').DataTable({
        ...
        "columnDefs": [
            ...
            {   targets: 4,
                ...
                "render": function ( d, type, row, meta ) {
                    if (type=='display')
                        return d.Projectlink==''?'':`<a target="blank" href="https://github.com/iDataVisualizationLab/CS5352/blob/master/talks/${d.Projectlink}"><i class="fa fa-cloud-download"></i></a>`;
                    else
